...
import page.nafuchoco.neobot.api.module.exception.InvalidDescriptionException;
...
public class ModuleLoader {
    ...
    public ModuleLoader(Launcher launcher, ModuleRegistry moduleRegistry, String moduleDir) {
